...
package local_project.sparql2csv_0_1;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_sparql2csv = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_sparql2csv = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_sparql2csv.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_sparql2csv.length == 0) {
   					commonByteArray_LOCAL_PROJECT_sparql2csv = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_sparql2csv = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_sparql2csv, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_sparql2csv, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_sparql2csv) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.outputFile)).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sparql2csv.class.getClassLoader().getResourceAsStream("local_project/sparql2csv_0_1/contexts/"+contextStr+".properties");
...
/************************************************************************************************
 *     63343 characters generated by Talend Open Studio for Big Data 
 *     on the November 23, 2017 9:56:41 AM CET
 ************************************************************************************************/